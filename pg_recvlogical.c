...
usage(void)
{
	...
	printf(_("  -b, --broker=protocol://host:port/params receive log into this broker, eg:kafka://host:port/topic\n"));
...
StreamLogicalLog(void)
{
	...
	//	}
		...
		//				bytes_left);
            ...
            BridgeToBroker(copybuf+hdr_len+bytes_written, bytes_left);
...
/* action */
	...
	while ((c = getopt_long(argc, argv, "f:b:F:nvd:h:p:U:wWI:o:P:s:S:",
